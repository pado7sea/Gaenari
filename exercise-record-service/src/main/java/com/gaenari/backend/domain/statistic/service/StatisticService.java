...
public interface StatisticService {
     ...
     */
    TotalStatisticDto getTotalStatistics(String accountId);
     ...
     */
    MonthStatisticDto getMonthlyExerciseStatistics(String accountId, int year, int month);
     ...
     */
    List<StatisticDto> getWeeklyExerciseStatistics(String accountId, int year, int month, int day);
