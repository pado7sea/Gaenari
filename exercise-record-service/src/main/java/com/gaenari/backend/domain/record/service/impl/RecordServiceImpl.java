...
public class RecordServiceImpl implements RecordService {
    ...
    @Override
    public List<RecordDto> getWholeExerciseRecords(String accountId) {
        List<Record> records = recordRepository.findAllByaccountId(accountId);
    ...
    @Override
    public MonthRecordDto getMonthlyExerciseRecords(String accountId, int year, int month) {
    ...
    @Override
    public WeekRecordDto getWeeklyExerciseRecords(String accountId, int year, int month, int day) {
        LocalDate startDate = LocalDate.of(year, month, day).with(ChronoField.DAY_OF_WEEK, 1); // 주의 시작 (일요일)
    ...
    @Override
    public List<RecordDto> getDailyExerciseRecords(String accountId, LocalDate date) {
        List<Record> records = recordRepository.findByAccountIdAndDateBetween(accountId, atStartOfDay(date),
