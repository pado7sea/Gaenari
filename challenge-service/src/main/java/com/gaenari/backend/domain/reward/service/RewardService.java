...
public interface RewardService {
     ...
     *
     * @param memberId String 형태로, 확인할 회원의 고유 식별자.
     ...
     *
     * @param memberId String 형태로, 보상을 받을 회원의 고유 식별자.
     ...
     *
     * @param memberId String 형태로, 코인을 업데이트할 회원의 고유 식별자.
     ...
     *
     * @param memberId String 형태로, 애정도를 업데이트할 회원의 고유 식별자.
