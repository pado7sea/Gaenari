...
public interface MemberChallengeRepository extends JpaRepository<MemberChallenge, Long> {
     ...
     */
    List<MemberChallenge> findByAccountId(String accountId);
     ...
     */
    List<MemberChallenge> findByAccountIdAndIsAchievedIsTrue(String accountId);
     ...
     */
    MemberChallenge findByAccountIdAndChallengeId(String accountId, Integer challengeId);
     ...
     * @return 도전과제 리스트
     */
    List<MemberChallenge> findByAccountIdAndObtainableGreaterThan(String accountId, int i);
