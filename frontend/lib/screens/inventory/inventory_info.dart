...
List<ItemInfo> info = [
  ItemInfo.fromJson({
    ...
    "setName": "블루하우스",
    "item": [
      {"itemId": 1, "itemName": "파란벽지", "category": "Wall"},
      {"itemId": 2, "itemName": "파란바닥", "category": "Floor"},
  ...
  ItemInfo.fromJson({
    ...
    "setName": "추억의교실",
    "item": [
      {"itemId": 7, "itemName": "교실칠판", "category": "Wall"},
      {"itemId": 8, "itemName": "마룻바닥", "category": "Floor"},
  ...
  ItemInfo.fromJson({
    ...
    "item": [
      ...
      {"itemId": 33, "itemName": "싸피로고", "category": "Rug"},
      {"itemId": 34, "itemName": "싸피명찰", "category": "Bowl"},
      {"itemId": 35, "itemName": "싸피노트북", "category": "Cushion"},
      {"itemId": 36, "itemName": "피우인형", "category": "Toy"}
    ]
  }),
  ItemInfo.fromJson({
    "setId": 7,
