...
class RCircleProgress @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0
) : View(context, attrs, defStyleAttr) {
    private var progress = 0f
    private val paint = Paint(Paint.ANTI_ALIAS_FLAG)
    private val rect = RectF()
    private val trackColor: Int = ContextCompat.getColor(context, R.color.run1) // 트랙 색상
    private val progressColor: Int = ContextCompat.getColor(context, R.color.run2) // 프로그레스 색상
