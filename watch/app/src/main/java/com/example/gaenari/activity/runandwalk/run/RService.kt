...
class RService : Service(), SensorEventListener {
...
//            wakeLock?.acquire() // WakeLock 활성화
    ...
    private fun initRequestDto() {
        ...
        requestDto = SaveDataRequestDto(
            ...
            exerciseType = "R", programType = "DEFAULT" , program = null,
...
//        wakeLock?.release()
    ...
    inner class LocalBinder : Binder() {
        fun getService(): RService = this@RService
    }
    ...
    private fun setupUpdateReceiver(){
        ...
        LocalBroadcastManager.getInstance(this@RService)
