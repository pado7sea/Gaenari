...
class DCircleProgress @JvmOverloads constructor(
    ...
    private val trackColor: Int = ContextCompat.getColor(context, R.color.dd1) // 트랙 색상
    private val progressColor: Int = ContextCompat.getColor(context, R.color.blue) // 프로그레스 색상
